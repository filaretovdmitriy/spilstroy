...
$Config['Enabled'] = $_SESSION['CKFSYS_ENABLED'];
...
$Config['ThumbMaxGenerate'] = 100; // Максимальное количество превьюшек, генерируемое за раз, если вдруг их нет
...
$Config['QuickUploadPath']['Flash']		= $Config['UserFilesPath'] . 'files/' ;
$Config['QuickUploadAbsolutePath']['Flash']= $Config['UserFilesAbsolutePath'] . 'files/' ;
...
$Config['FileTypesPath']['ImageThumb']		= $Config['UserFilesPath'] . '.thumbs/' ;
$Config['FileTypesAbsolutePath']['ImageThumb']= ($Config['UserFilesAbsolutePath'] == '') ? '' : $Config['UserFilesAbsolutePath'].'.thumbs/';
...
if (isset($_GET['js_conf'])) {
	$Config_js = array('Delete', 'ThumbList', 'ThumbListSize', 'ThumbCreate',
		'AllowedExtensions.File', 'AllowedExtensions.Image', 'AllowedExtensions.Flash');
