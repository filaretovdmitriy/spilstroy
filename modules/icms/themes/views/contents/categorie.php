...
<div class="data">
    ...
    <?php
        ...
        <?php $tabs->beginTab() ?>
            <div class='col-70'>
                <?= $form->field($model, 'name')->textInput(['class' => 'width-100'])->label('Название раздела') ?>
                <?= $form->field($model, 'in_preview')->textInput(['class' => 'width-100'])->label('Отображать в превью') ?>
                <?= $form->field($model, 'in_list')->textInput(['class' => 'width-100'])->label('Отображать в списке') ?>
            </div>
